...
public class TecRemotoRepository implements Serializable {
	...
	public List<TecRemoto> findAll() throws Exception {
		...
		TypedQuery<TecRemoto> query = em.createQuery("FROM TecRemoto tec", TecRemoto.class);
	...
	public Optional<TecRemoto> findById(Long id) throws Exception {
		...
		TypedQuery<TecRemoto> query = em.createQuery("FROM TecRemoto tec WHERE tec.id=?1", TecRemoto.class);
	...
	public List<TecRemoto> findByName(String name) throws Exception {
		...
		TypedQuery<TecRemoto> query = em.createQuery("FROM TecRemoto tec WHERE tec.name LIKE ?1", TecRemoto.class);
