...
public class EspecialidadRepository implements Serializable {
	...
	public List<Especialidad> findAll() throws Exception {
		...
		TypedQuery<Especialidad> query = em.createQuery("From Especialidad e Where e.id=?1", Especialidad.class);
	...
	public List<Especialidad> findByName(String nombre) throws Exception {
		...
		TypedQuery<Especialidad> query = em.createQuery("From Especialidad e WHERE e.name LIKE ?1", Especialidad.class);
